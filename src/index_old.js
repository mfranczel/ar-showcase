...
import target from './nfts/multitarget-erste-2.mind'
...
let anchor, anchor1a, anchor1b, anchor2a, anchor2b, anchor2c, anchor3a, anchor4, anchor5a, anchor5b;

renderer.gammaOutput = true;

anchor = mindarThree.addAnchor(0);  // Button - Done

anchor1a = mindarThree.addAnchor(1); // notebook TODO: GIF
anchor1b = mindarThree.addAnchor(2); // notebook TODO: GIF

anchor2a = mindarThree.addAnchor(3); // Colored Text: TODO: obrazky pre nalepky, ikonky pre linky
// anchor2b = mindarThree.addAnchor(4); 
// anchor2c = mindarThree.addAnchor(5);

anchor3a = mindarThree.addAnchor(6); // shirt CODE
// anchor3b = mindarThree.addAnchor(7); // shirt DATA

// anchor3 = mindarThree.addAnchor(6); // airtag
anchor4 = mindarThree.addAnchor(7); // battery

anchor5a = mindarThree.addAnchor(8); // puzzle TODO: animacie, rozbijanie
anchor5b = mindarThree.addAnchor(9); // puzzle TODO: animacie, rozbijanie
...
const material_g = new THREE.MeshMatcapMaterial( {matcap: matcapImageGreen} );
const material_b = new THREE.MeshMatcapMaterial( {matcap: matcapImageBlue} );
...
fontLoader.load(
    ...
    anchor1b.group.add(noteText)
    
    anchor2a.group.add(coloredText)
    //anchor2b.group.add(coloredText.clone())
    //anchor2c.group.add(coloredText.clone()) 

    anchor3a.group.add(coloredText.clone())

    // anchor3.group.add(airTagText)
    anchor4.group.add(powerbankText)

    anchor5a.group.rotation.set(Math.PI * 1,0,0)
    anchor5a.group.add(puzzleText)
    anchor5a.group.add(puzzleText2)
    anchor5a.group.add(puzzleText3)
    anchor5a.group.add(puzzleText4)
    anchor5a.group.add( dec )
    anchor5a.group.add(arrowHelper)
    anchor5a.group.add(arrowHelperSuccess)
    anchor5a.group.add(arrowHelperFail)

    anchor5b.group.rotation.set(Math.PI * 1,0,0)
    anchor5b.group.add(puzzleText.clone())
    anchor5b.group.add(puzzleText2.clone())
    anchor5b.group.add(puzzleText3.clone())
    anchor5b.group.add(puzzleText4.clone())
    anchor5b.group.add( dec.clone() )
    anchor5b.group.add(arrowHelper.clone())
    anchor5b.group.add(arrowHelperSuccess.clone())
    anchor5b.group.add(arrowHelperFail.clone())
    }
)
...
gltfLoader.load(
    ...
    (gltf) => {
        ...
        //anchor2b.group.add(r.clone())
        //anchor2c.group.add(r.clone()) 
        anchor3a.group.add(r.clone()) 
        // anchor3b.group.add(r) 
        anchor2a.group.add(g)
        //anchor2b.group.add(g.clone())
        //anchor2c.group.add(g.clone()) 
        anchor3a.group.add(g.clone()) 
        // anchor3b.group.add(g) 
        anchor2a.group.add(b.clone())
        //anchor2b.group.add(b.clone())
        //anchor2c.group.add(b.clone()) 
...
els.forEach((el) => {
    ...
    //anchor2b.group.add(el.clone())
    //anchor2c.group.add(el.clone()) 
    anchor3a.group.add(el.clone()) 
    // anchor3b.group.add(el) 
})
...
mindarThree.anchors.forEach((an, i) => {
    an.onTargetFound = (e) => console.log(i + " Found")
    an.onTargetLost = (e) => console.log(i + " Lost")
})
